...
export default function HomeFinalCta() {
  return (
   <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] px-5 py-14 text-center shadow-[0_0_60px_rgba(170,100,255,0.10)] sm:px-6 md:px-10 md:py-16">
